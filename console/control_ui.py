...
def print_help(self):
    ...
    self.command_output.add_line('\tstop              - Stop active "echo topic"')
...
class AP1DebugUI(QMainWindow):
    ...
    def __init__(self, node: AP1ConsoleNode, app: QApplication):
        ...
        # Left pane
        left_pane = QWidget()
        left_pane.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Expanding)
        ...
        left_layout.addWidget(self.path_canvas, stretch=1)

        # Right pane
        right_pane = QWidget()
        right_pane.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Expanding)
                ...
                def run_echo():
                    try:
                        ...
                        for line in process.stdout:
                            ...
                            self.echo_output_signal.emit(line.rstrip())
